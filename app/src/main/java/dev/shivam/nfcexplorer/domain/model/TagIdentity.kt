 ...
 *
 * [atqa] and [sak] are null when the tag was not reached over NfcA, and the [BccCheck]
 * fields are null when the pages carrying them could not be read. Null means
 * "not established", which the UI must render distinctly from a zero value.
 */
