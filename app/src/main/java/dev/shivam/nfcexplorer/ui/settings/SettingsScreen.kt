...
fun SettingsScreen(
    ...
    Column(
        ...
        SectionCard(
            ...
            // Stated in the card body, not as a subtitle. Whether a credential is stored is the
            // question this section exists to answer, and a muted line under the heading was quiet
            // enough to read as "nothing here".
            Row(
            ...
            OutlinedTextField(
                ...
                label = {
                    Text(
                        stringResource(
                            if (state.togglTokenSet) R.string.settings_toggl_replace
                            else R.string.settings_toggl_token,
                        ),
                    )
                },
                ...
                trailingIcon = {
                    // Disabled on an empty field: revealing nothing looks like a broken button.
                    IconButton(
                        onClick = onToggleTokenVisibility,
                        enabled = state.togglDraft.isNotEmpty(),
                    ) {
